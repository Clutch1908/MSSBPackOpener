...
def openPack():
    ...
    cardThree = _sysrand.randint(1,24)
    ...
    cardFour = _sysrand.randint(1,24)
    ...
    cardFive = _sysrand.randint(1,24)
    ...
    cardSeven = _sysrand.randint(1,24)
